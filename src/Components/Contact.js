  ...
  return (
    <div className="absolute top-48 overflow-y-auto bottom-0 left-0 right-0 dark:text-slate-200">
      <h1 className="font-h1Font text-8xl text-center">
        Contact page
        <p className=" text-sm italic">Please fill out all fields.</p>
      </h1>
          ...
          <div className="-mx-3 md:flex mb-6 flex justify-center items-center">
            <div>
              ...
              <textarea
                ...
                className=" block p-4 w-full h-24 bg-grey-lighter text-black border-grey-lighter rounded py-3 px-4 mb-6 "
              ></textarea>
            ...
            <button
              type="button"
              className=" bg-[##586880] hover:bg-[#F7B023] text-white px-4 py-2 font-large rounded "
            >
